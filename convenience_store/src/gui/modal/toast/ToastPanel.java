...
import gui.modal.toast.icon.RollingIcon;
import gui.modal.toast.option.ToastOption;
import gui.modal.toast.option.ToastStyle;
...
public class ToastPanel extends JPanel {
    ...
    private JButton createCloseButton() {
        JButton buttonClose = new JButton(new FlatSVGIcon("gui/modal/icon/close.svg", 0.3f));
