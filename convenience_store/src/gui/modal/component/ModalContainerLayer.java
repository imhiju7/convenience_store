...
import gui.modal.layout.FullContentLayout;
...
public class ModalContainerLayer extends JLayeredPane {
    ...
    protected void showSnapshot() {
        ...
        isFullWindowContent = FlatClientProperties.clientPropertyBoolean(rootPaneContainer.getRootPane(), FlatClientProperties.FULL_WINDOW_CONTENT, false);
