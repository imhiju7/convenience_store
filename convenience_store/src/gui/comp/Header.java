...
public class Header extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/source/image/icon/profile.jpg"))); // NOI18N
        ...
        buttonBadges1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/source/image/icon/notification.png"))); // NOI18N
        buttonBadges1.setBadges(12);

        buttonBadges2.setForeground(new java.awt.Color(63, 178, 232));
        buttonBadges2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/source/image/icon/message.png"))); // NOI18N
